...
import org.platanios.symphony.data.mt.Utilities.MosesDecoder
import org.platanios.symphony.data.utilities.CompressedFiles
...
/**
  ...
  */
object EuroparlManager extends Manager {
  val url: String = "http://www.statmt.org/europarl/v7"

  override protected val logger = Logger(LoggerFactory.getLogger("Europarl Data Manager"))
  ...
  def main(args: Array[String]): Unit = {
    val path = Paths.get("/Users/anthony/Downloads/temp")
    download(path, BulgarianEnglish)
    preprocess(path, BulgarianEnglish, bufferSize = 8192, useMoses = true, numThreads = 8)
  }
}
